...
public class Login extends HttpServlet
{
	...
	{
		String email=request.getParameter("1");

		String passwordd=request.getParameter("2");
...
//				String password = "Siraj@mysql12345";
			...
			String s="select email,passwordd from cust4 where email='"+email+"' and passwordd='"+passwordd+"'";
			...
			{
				RequestDispatcher rd=request.getRequestDispatcher("tryagainhtml.html");
				rd.forward(request,response);
			}
				connection.close();
			}
